...
for queue in queues:
    ...
    print(f"{queue:<8} {cc.bold}{cc.yellow if running_jobs < max_running else cc.green}{running_jobs:>5}{cc.reset_format} {max_running:>4} {cc.red if pending_jobs == 0 else cc.reset_format}{cc.bold}{pending_jobs:>8}{cc.reset_format} {cc.bold}{cc.cyan}{free_slots:>5}{cc.reset_format}") 

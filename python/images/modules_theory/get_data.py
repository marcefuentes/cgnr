...
def get_data(data):
    ...
    data["alphas"] = np.linspace(get_config("alpha_max"), get_config("alpha_min"), num=ss.NC)
    data["logess"] = np.linspace(get_config("loges_min"), get_config("loges_max"), num=ss.NC)
